    ...
    return (
        ...
        >
            ...
            <main className="relative z-10 w-full max-w-5xl px-4 flex justify-center items-center">
                <div
                    ref={cardRef}
                    className="group/card relative z-20 w-full max-w-4xl overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-2xl transition-all duration-500 hover:border-blue-500/40 hover:shadow-[0_0_50px_-12px_rgba(59,130,246,0.3)]"
                >
                    ...
                    <div
                        ...
                        style={{
                            background: `radial-gradient(600px circle at var(--card-mouse-x) var(--card-mouse-y), rgba(59, 130, 246, 0.15), transparent 80%)`
                        }}
                    />
                    ...
                    <div className="grid md:grid-cols-2 relative z-10">
                        ...
                        <div className="relative hidden md:flex flex-col justify-between p-12 bg-white/[0.02] border-r border-white/5">
                            <div className="relative z-10">
                                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-500/10 mb-6 border border-blue-500/20">
                            ...
                            <div className="relative z-10 mt-12">
                                <div className="flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-5 py-2.5 w-fit backdrop-blur-xl transition-all duration-300 hover:bg-white/10 hover:border-white/20 group/badge cursor-default">
                                    <div className="relative h-2 w-2">
                                        ...
                                        <div className="relative h-2 w-2 rounded-full bg-blue-500 shadow-[0_0_10px_#3b82f6]"></div>
                                    </div>
                                    <span className="text-[10px] font-mono text-slate-400 tracking-widest uppercase group-hover/badge:text-slate-300 transition-colors">System Operational</span>
                                </div>
                            </div>
                        </div>
